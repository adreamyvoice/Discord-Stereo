...
[![Windows](https://img.shields.io/badge/Windows-Active-00C853?style=flat-square)](https://github.com/adreamyvoice/Discord-Stereo#windows-voice-fixer)
[![macOS](https://img.shields.io/badge/macOS-Active-00C853?style=flat-square)](https://github.com/adreamyvoice/Discord-Stereo#macos)
[![Linux](https://img.shields.io/badge/Linux-Active-00C853?style=flat-square)](https://github.com/adreamyvoice/Discord-Stereo#linux-launcher)
...
**Stereo Hub** — **[latest release on GitHub](https://github.com/adreamyvoice/Discord-Stereo/releases/latest)** (always the current Stereo Hub build). Download **`discord_stereo_hub.py`** from that page (same file as [`STEREO HUB/discord_stereo_hub.py`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/STEREO%20HUB/discord_stereo_hub.py) on `main`) and run it with **Python 3.8 or higher** — this is the supported entry for everyone **EXCEPT MacOS!!!** as the Codeberg is down and the patcher will be merging to this repo soon — see [**macOS**](#macos).
...
> Older flow: **v0.5** [`Updates.zip`](https://github.com/adreamyvoice/Discord-Stereo/releases/tag/v0.5) and the full [`Updates/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates) tree on `main` still exist if you need scripts or bundles outside Stereo Hub.
...
|  |  |
|:---|:---|
| 📦 **GitHub Releases** | **[Latest Stereo Hub](https://github.com/adreamyvoice/Discord-Stereo/releases/latest)** · [all releases](https://github.com/adreamyvoice/Discord-Stereo/releases) |
| 🍎 **macOS** | [**macOS**](#macos) |
| 🔗 **Latest scripts** | **[`Updates/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates)** on `main` |
...
1. Grab [`Stereo Installer.bat`](https://github.com/adreamyvoice/Discord-Stereo/raw/main/Updates/Windows/Stereo%20Installer.bat) from [`Updates/Windows/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Windows).
...
The `.bat` fetches [`DiscordVoiceFixer.ps1`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/DiscordVoiceFixer.ps1) from `main`. Admin avoids permission issues under `%LOCALAPPDATA%\Discord\`.
...
**CLI:** [`Updates/Linux/Updates/discord_voice_patcher_linux.sh`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Linux/Updates/discord_voice_patcher_linux.sh) — `g++`, `chmod +x`, `./discord_voice_patcher_linux.sh --help`
...
Run [`Stereo-Node-Patcher-Windows.BAT`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/Stereo-Node-Patcher-Windows.BAT) (pulls [`Discord_voice_node_patcher.ps1`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/Discord_voice_node_patcher.ps1) from `main`). Bad match? [**Offset Finder**](#offset-finder) → **copy** block → **paste** into offsets in `Discord_voice_node_patcher.ps1` → re-run.
...
Scripts: [CLI `discord_voice_node_offset_finder_v5.py`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Offset%20Finder/discord_voice_node_offset_finder_v5.py) · [GUI `offset_finder_gui.py`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Offset%20Finder/offset_finder_gui.py) in [`Updates/Offset Finder/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Offset%20Finder) · **macOS (Swift):** [Codeberg](https://codeberg.org/DiscordStereoPatcher-macOS) if up, else **[macOS](#macos)** (section below, outside this toggle).
...
| Path | Contents |
|------|----------|
| [`Updates/Windows/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Windows) | Voice Fixer, Advanced Windows patching (`.BAT` + PS1) |
| [`Updates/Linux/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Linux) | **[`discord-stereo-launcher.sh`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Linux/discord-stereo-launcher.sh)** (main entry — GUI mode picker); `Updates/Linux/Updates/` — patcher + installer scripts |
| [`Updates/Offset Finder/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Offset%20Finder) | Offset finder CLI and GUI |
| [`Updates/Nodes/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Nodes) | `Unpatched` / `Patched` reference voice bundles (see subfolders) |
| — | **macOS (Swift):** not in `Updates/` here — [Codeberg](https://codeberg.org/DiscordStereoPatcher-macOS) · [**macOS**](#macos) |

[`Voice Node Dump/`](https://github.com/adreamyvoice/Discord-Stereo/tree/main/Voice%20Node%20Dump) (repo root) — research / archives
...
### `main` (now)
Tags: **[latest Stereo Hub](https://github.com/adreamyvoice/Discord-Stereo/releases/latest)** (`discord_stereo_hub.py`), legacy **[v0.5](https://github.com/adreamyvoice/Discord-Stereo/releases/tag/v0.5)** (`Updates.zip`). **Codeberg** (macOS) down → [**macOS**](#macos)
...
**Voice Fixer** ([`Stereo Installer.bat`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/Stereo%20Installer.bat) → [`DiscordVoiceFixer.ps1`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/DiscordVoiceFixer.ps1)) installs **pre-patched** `discord_voice.node` files. **No compiler.**

**Advanced Windows patching** ([`Stereo-Node-Patcher-Windows.BAT`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/Stereo-Node-Patcher-Windows.BAT) → [`Discord_voice_node_patcher.ps1`](https://github.com/adreamyvoice/Discord-Stereo/blob/main/Updates/Windows/Discord_voice_node_patcher.ps1)) builds the patcher on your machine and edits the binary. **Needs a C++ compiler.** Use when Voice Fixer isn’t enough — new Discord build, custom offsets, or you want full control.
...
[Shaun (sh6un)](https://github.com/sh6un) · [UnpackedX](https://codeberg.org/UnpackedX) · [Voice Playground](https://discord-voice.xyz/) · [Oracle](https://github.com/oracle-dsc) · [Loof-sys](https://github.com/LOOF-sys) · [Hallow](https://github.com/adreamyvoice) · [Ascend](https://github.com/bloodybapestas) · BluesCat · [Sentry](https://github.com/sentry1000) · [Sikimzo](https://github.com/sikimzo) · [CRÜE](https://codeberg.org/DiscordStereoPatcher-macOS) · [HorrorPills / Geeko](https://github.com/HorrorPills)

---

## 💬 Get involved

**[Report an issue](https://github.com/adreamyvoice/Discord-Stereo/issues)** · **[Join the Discord](https://discord.gg/gDY6F8RAfM)**
