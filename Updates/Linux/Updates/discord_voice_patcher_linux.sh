...
# https://github.com/adreamyvoice/Discord-Stereo/tree/main/Updates/Nodes/Unpatched%20Nodes%20(For%20Patcher)/Linux
VOICE_BACKUP_DIR="${VOICE_BACKUP_DIR:-$CACHE_DIR/VoiceBackupLinux}"
VOICE_BACKUP_API="${VOICE_BACKUP_API:-https://api.github.com/repos/adreamyvoice/Discord-Stereo/contents/Updates%2FNodes%2FUnpatched%20Nodes%20%28For%20Patcher%29%2FLinux}"
# endregion Config
